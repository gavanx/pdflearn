...
public final class AddAnnotations {
  ...
  public static void main(String[] args) throws IOException {
    args = new String[]{"/home/work/gwork/leoedu/github/pdf/mupdf/mupdf-1.10a-source/out_box.pdf"};
    if (args.length != 1) {
    ...
    try {
      ...
      FDFAnnotationInk ink = new FDFAnnotationInk();
      List<float[]> inkList = new ArrayList<float[]>(10);
      for (int i = 1; i < 11; i++) {
        inkList.add(new float[]{10f * i, 10f * i});
      }
