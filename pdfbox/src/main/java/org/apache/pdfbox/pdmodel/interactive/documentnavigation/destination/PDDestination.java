...
public abstract class PDDestination implements PDDestinationOrAction {
  ...
  public static PDDestination create(COSBase base) throws IOException {
    ...
    if (base == null) {
      ...
      if (typeString.equals(PDPageFitDestination.TYPE) || typeString.equals(PDPageFitDestination.TYPE_BOUNDED)) {
        retval = new PDPageFitDestination(array);
      } else if (typeString.equals(PDPageFitHeightDestination.TYPE) || typeString.equals(PDPageFitHeightDestination.TYPE_BOUNDED)) {
      ...
      } else if (typeString.equals(PDPageFitWidthDestination.TYPE) || typeString.equals(PDPageFitWidthDestination.TYPE_BOUNDED)) {
