...
public class PDFTemplateCreator {
  ...
  public InputStream buildPDF(PDVisibleSignDesigner properties) throws IOException {
    ...
    pdfBuilder.createImageForm(imageFormResources, innerFormResource, imageFormStream, formatter, transform, pdfStructure.getImage());
    ...
    pdfBuilder.injectAppearanceStreams(holderFormStream, imageFormStream, imageFormStream, imgFormName, imgName, innerFormName, properties);
