...
abstract class TrueTypeEmbedder implements Subsetter {
   ...
   */
  TrueTypeEmbedder(PDDocument document, COSDictionary dict, InputStream ttfStream, boolean embedSubset) throws IOException {
   ...
   */
  protected abstract void buildSubset(InputStream ttfSubset, String tag, Map<Integer, Integer> gidToCid) throws IOException;
