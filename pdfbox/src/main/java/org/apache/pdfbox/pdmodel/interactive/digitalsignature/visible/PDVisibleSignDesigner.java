...
public class PDVisibleSignDesigner {
  ...
  public byte[] getAffineTransformParams() {
    return new byte[]{(byte) affineTransform.getScaleX(), (byte) affineTransform.getShearY(), (byte) affineTransform.getShearX(),
      (byte) affineTransform.getScaleY(), (byte) affineTransform.getTranslateX(), (byte) affineTransform.getTranslateY()};
  }
  ...
  public PDVisibleSignDesigner affineTransformParams(byte[] affineTransformParams) {
    affineTransform = new AffineTransform(affineTransformParams[0], affineTransformParams[1], affineTransformParams[2], affineTransformParams[3], affineTransformParams[4], affineTransformParams[5]);
    return this;
  }
